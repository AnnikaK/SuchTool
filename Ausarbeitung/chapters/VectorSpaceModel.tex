...
\end{equation} (\cite{Manning:08}, S.111)

\begin{figure} [http]
	\centering
	\includegraphics[width=0.5\textwidth]{images/vector_space.png}
	\caption{Vektorraum mit den Termen $T1$ und $T2$ als Achsen, drei Dokumentvektoren $d_i$ und dem Anfragevektor $q$. Das Cosinus-Maß liefert als ähnlichsten Dokumentvektor $d_2$ (Eigene Abbildung).}
\end{figure}
