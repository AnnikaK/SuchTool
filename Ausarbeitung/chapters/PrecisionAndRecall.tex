...
Der Begriff lässt sich zudem mathematisch wie in Definition \ref{Relevance} angegeben definieren (\cite{Ferber:03}, S.86). \\ 
...
Precision bedeutet übersetzt Präzision und bezeichnet den Anteil relevanter Dokumente an allen zurückgelieferten Dokumenten. Formel \ref{prec} beschreibt die Berechnung, wobei $\#$ die Kardinalität bezeichnet.
