...
\begin{figure} [http]
	...
	\caption{Anzeige der Gesamtanfrage auf dem oberen Display, das sich in Bereich b befindet (eigene Abbildung).}
	\label{c}
...
\begin{figure} [http]
	...
	\caption{Scrollbare Anzeige, um beliebig viele Treffer anzeigen zu können (eigene Abbildung).}
	\label{res}
