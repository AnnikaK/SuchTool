...
\begin{figure} [http]
	...
	\caption{Gliederung der Benutzeroberfläche. Teil a beinhaltet die Verzeichnisauswahl, Teil b die gesamte Suchanfrage und Teil c die Erstellung der Teilanfrage (Eigene Abbildung).}
	\label{overview}
...
\begin{figure} [http]
	...
	\centering
	\includegraphics[width=1\textwidth]{images/a}
...
\begin{figure} [http]
	...
	\centering
	\includegraphics[width=1\textwidth]{images/b}
...
\begin{figure} [http]
	...
	\centering
	\includegraphics[width=1\textwidth]{images/c}
