...
In der Regel enthalten die Dokumente weitaus mehr Attribute als in diesem Beispiel, zudem können sich die Attributwerte auch über mehrere Zeilen erstrecken. Zusätzlich enthalten die Dokumente oft durch ein Semikolon gekennzeichnete Kommentare (siehe Abbildung \ref{example}, Z.1, Z.17), die vom System als Freitext interpretiert werden. \\
Beim gezeigten Beispiel handelt es sich zwar um eine E-Mail, es können allerdings auch andere Dokumente vorliegen. Die einzige Bedingung für die korrekte Funktionsweise des Systems ist, dass die im Archiv enthaltenen Dokumente die in \ref{struct} vorgegebene Struktur erfüllen. Die Attribute können darum inhaltlich vollkommen abweichend ausfallen, abhängig davon welche Art von Archiv durchsucht wird.
...
Demnach erhält ein Dokument, dass für 5 Teilanfragen einen Treffer in der Metadatensuche liefert, den Score 5. Handelt es sich hingegen um einen nicht ganzzahligen Wert, z.B. $5.27$, kamen noch Treffer in der Freitextsuche hinzu. \\
