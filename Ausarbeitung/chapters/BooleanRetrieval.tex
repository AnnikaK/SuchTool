...
($Kontaktadresse$ $OR$ $Seminar$) $AND$ ($Termin$ $OR$ $Seminar$), werden erst die inneren Ausdrücke ausgewertet und aus den entstandenen Ergebnislisten in aufsteigend nach Länge sortierter Reihenfolge der Durchschnitt gebildet (\cite{Manning:08}, S.11).
