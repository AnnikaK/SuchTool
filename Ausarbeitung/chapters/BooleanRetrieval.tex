...
\subsection{Term-Inzidenz-Matrix}
\label{matrix}
...
\begin{figure} [hbtp]
	...
	\caption{Invertierte Listen zu Beispieltermen. Die Zahlen sind die Dokumentindizes oder auch \textit{docID}s, in denen der jeweilige Term vorkommt (Eigene Abbildung).}
	\label{abb1}
\end{figure}
