...
; value: eine Liste aller AusdrŸcke in der Datei.
  (let (res)
    (setq res nil)
...
; input: ein dateiname (vollstŠngiger Pfad)
;        eine Liste von AusdrŸcke.
; effekt: ausdrŸcke werden in datei geschrieben
...
; input: ein dateiname (vollstŠngiger Pfad)
;        eine Liste von AusdrŸcke.
; effekt: ausdrŸcke werden in datei hinzugefügt
  (let (outstream)
